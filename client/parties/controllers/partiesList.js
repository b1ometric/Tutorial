angular.module("socially").controller("PartiesListCtrl", ['$scope', '$meteorCollection', '$meteorSubscribe', '$meteorUtils', '$rootScope', '$meteorMethods',
  function($scope, $meteorCollection, $meteorSubscribe, $meteorUtils, $rootScope, $meteorMethods){
